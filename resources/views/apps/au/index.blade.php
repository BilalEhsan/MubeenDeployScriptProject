@include('apps.au.partials.header')
<style type="text/css">
    .home-bg-banner {
...
<section>
    <div>
        <div class="mt-4" style="text-align: center;">
            <p style="color: #c00d0d;font-size: 20px;font-weight: 600;margin: 0px;">AU template</p>
            <p>Australian template</p>
        </div>
    </div>
...
@include('apps.au.partials.footer')
